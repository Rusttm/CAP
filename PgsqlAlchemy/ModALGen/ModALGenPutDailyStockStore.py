...
class ModALGenPutDailyStockStore(ModALGenMainClass, ConnALTable):
    ...
    def update_daily_stock_store(self, **kwargs):
    ...
    def put_data_to_daily_stock_store_table(self, table_year: datetime = None,
        ...
        from PgsqlAlchemy.ConnAL.ConnALGenDailyStockStoreTable import ConnALGenDailyStockStoreTable
        table_filler = ConnALGenDailyStockStoreTable()
        if not from_date:
        ...
        while work_date < end_date:
            ...
            if data_list:
                ans = table_filler.put_data_in_daily_stock_store_table(**req_dict2)
...
if __name__ == '__main__':
    generator = ModALGenPutDailyStockStore()
