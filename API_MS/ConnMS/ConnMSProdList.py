...
class ConnMSProdList(ConnMSMainClass):
    ...
    def get_prod_list_filtered_by_updated(self, from_date=None, to_date=None, to_file=False):
...
if __name__ == '__main__':
    ...
    prods = connector.get_prod_list_filtered_by_updated(from_date="2022-01-01", to_date="2023-02-01", to_file=True)
    print(prods)