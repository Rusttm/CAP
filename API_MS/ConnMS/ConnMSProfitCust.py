...
class ConnMSProfitCust(ConnMSMainClass):
    """ connector to MoiSklad profit by customers"""
    request_url = 'url_profit_by_cust_list'
    """ requested api url"""
    ...
    def get_profit_by_cust(self, from_date=None, to_date=None, to_file=False):
        """ return dict with profit by customers
        ...
        if to_file:
            ...
            ConnMSSaveJson().save_data_json_file(data_dict=new_data_dict, file_name="profit_cust_sum.json")
        return new_data_dict


if __name__ == '__main__':
    connector = ConnMSProfitCust()
    data = connector.get_profit_by_cust(from_date="2023-05-01", to_date="2023-05-15", to_file=True)
    print(data["sum"])
