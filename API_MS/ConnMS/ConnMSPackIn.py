...
class ConnMSPackIn(ConnMSMainClass):
    """class to connect inner packlists"""
    request_url = 'url_inpack_list'
    ...
    def get_packin_filtered_by_date(self, from_date=None, to_date=None, to_file=False):
    ...
    def get_packin_filtered_by_create(self, from_date=None, to_date=None, to_file=False):
...
if __name__ == '__main__':
    connector = ConnMSPackIn()
    connector.get_packin_filtered_by_date(from_date="2023-01-01", to_date="2023-02-01", to_file=True)