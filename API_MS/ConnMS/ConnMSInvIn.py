...
class ConnMSInvIn(ConnMSMainClass):
    """class to connect payments out"""
    request_url = 'url_ininvoices_list'
    ...
    def get_invin_filtered_by_date(self, from_date=None, to_date=None, to_file=False):
    ...
    def get_invin_filtered_by_create(self, from_date=None, to_date=None, to_file=False):
