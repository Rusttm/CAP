...
class ContPgsqlDailyUpdaterAir(ContPgsqlMainClass, ConnPgsqlDataGet, ConnPgsqlDataPut, ConnPgsqlDataHandler, ConnPgsqlRowCount, ContPgsqlEvent):
    ...
    def update_all_daily_report_tables(self):
        ...
        for table_name, data_dict in self.tables_dict.items():
            ...
            if data_dict.get('sql_upd', None) != 2:
                continue
...
if __name__ == '__main__':
    connector = ContPgsqlDailyUpdaterAir()
