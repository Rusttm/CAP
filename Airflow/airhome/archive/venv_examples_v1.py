...
@task.external_python(python="/home/rusttm/PycharmProjects/CAP/PgsqlAlchemy/alch_env/bin/python", task_id="ext_venv_python")
def python_alchemy_version_operator():
    sys.path.append("/home/rusttm/PycharmProjects/CAP")
...
with DAG(default_args=default_args,
    ...
    venv_task = ExternalPythonOperator(
        task_id="p310",
        python="/home/rusttm/PycharmProjects/CAP/PgsqlAlchemy/alch_env/bin/python",
    ...
    my_command = "/home/rusttm/PycharmProjects/CAP/PgsqlAlchemy/updaters_ub.sh"
    if os.path.exists(my_command):
        my_command = """source /home/rusttm/PycharmProjects/CAP/PgsqlAlchemy/alch_env/bin/activate && 
        exec python /home/rusttm/PycharmProjects/CAP/PgsqlAlchemy/ModALUpdaters/ModALTestVersion.py"""
